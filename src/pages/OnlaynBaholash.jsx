    ...
    <>
      <header className='bg-gray-100'>
        <div className='flex items-center space-x-5'>
          <div>
            <img style={{ width: '1300px', height: '400px' }} src={BrotherImage} alt="GirlImage" />
          </div>
          <div className={`${styles.HeaderContainer} p-10`}>
            <span className='text-7xl font-medium font-serif'>Shveytsariya soatlarini onlayn baholash</span>
            <br />
            <p className='font-serif text-lg w-[600px] pt-5'>Shveytsariya qo'l soatlarining dastlabki narxini bilish uchun ushbu sahifadagi shaklni to'ldirishingiz mumkin.</p>
            <p className='font-serif text-lg w-[600px]'> Yuqori sifatli fotosuratlarning mavjudligi xarajatlarni aniqlashni aniqroq qiladi - 95% gacha.</p>
          </div>
        </div>
      </header>
      <p>  <div className='text-center py-10 text-xl leading-8 font-serif w-[1000px] max-w-[1180px] mx-auto px-5'>
          <p>Xronograflaringizning haqiqiy qiymatini bilish uchun siz butun shahar bo'ylab tajribali baholovchini izlashingiz yoki forumlarni aylanib chiqishingiz shart emas. Moskvadagi taymer mutaxassislari har qanday ishlab chiqaruvchi va modelning Shveytsariya soatlarini baholash uchun etarlicha malakaga ega va ko'p yillik tajribaga ega. Bundan tashqari, biz maxsus shaklni to'ldirish va fotosurat yuborish orqali ushbu xizmatni masofadan turib taqdim etamiz. Soatlarni tekshirishda shaxsiy aloqani afzal ko'rgan mijozlar mahsulotni Kutuzovskiy prospektidagi Timer ofisiga etkazib berishlari mumkin. Biz yuzaga kelishi mumkin bo'lgan har qanday muammo bo'yicha ma'lumot beruvchi maslahat berishdan mamnun bo'lamiz.</p>
        </div></p>
