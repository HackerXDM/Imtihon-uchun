    ...
    <>
      <header className='bg-gray-100'>
        <div className='flex items-center'>
          <div>
            <img style={{ width: '900px', height: '400px' }} src={Girl} alt="GirlImage" />
          </div>
          <div className='p-10'>
            <span className='text-6xl font-medium font-serif'>Aksessuarlarni onlayn  Baholash</span>
            <p className='font-serif text-lg pt-5'>Shveytsariya qo'l soatlarining dastlabki narxini bilish uchun ushbu sahifadagi shaklni to'ldirishingiz mumkin.</p>
            <p className='font-serif text-lg'>Yuqori sifatli fotosuratlarning mavjudligi narxni aniqroq aniqlash imkonini beradi - 95% gacha</p>
          </div>
        </div>
      </header>
        <div className='text-center text-xl py-5 leading-8 font-serif w-full max-w-[1180px] mx-auto px-5'>
